...
{
    /// <summary>
    /// Interaction logic for Equip_Employee_Assignment_Overview.xaml
    /// </summary>
    public partial class Equip_Employee_Assignment_Overview : Window
    {
        public Equip_Employee_Assignment_Overview()
        {
            InitializeComponent();
        }
