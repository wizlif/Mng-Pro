...
{
    /// <summary>
    /// Interaction logic for General_Expenses_History_Detailed.xaml
    /// </summary>
    public partial class General_Expenses_History_Detailed : Window
    {
        public General_Expenses_History_Detailed()
        {
            InitializeComponent();
        }
