...
{
    /// <summary>
    /// Interaction logic for Fluid_Usage_Analysis_Prior_Year.xaml
    /// </summary>
    public partial class Fluid_Usage_Analysis_Prior_Year : Window
    {
        public Fluid_Usage_Analysis_Prior_Year()
        {
            InitializeComponent();
        }
