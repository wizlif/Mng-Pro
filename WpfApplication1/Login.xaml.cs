        ...
        private async void ButtonLogin_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                if (Convert.ToInt32(_cmd.ExecuteScalar()) == 1)
                {
                    ...
                    if (ComboBoxAccount.Text == "Other User")
                    {
                        MainWindow na = new MainWindow();
                ...
                //    else if (ComboBoxAccount.Text == "Other User")
                //    {
                ...
                //        this.Close();
                //    }
                //    else if (ComboBoxAccount.Text == "Human Resource Manager")
                //    {
                //        (new WindowHR()).Show();
