...
{
    /// <summary>
    /// Interaction logic for General_Expenses_Analysis_Prior_Year.xaml
    /// </summary>
    public partial class General_Expenses_Analysis_Prior_Year : Window
    {
        public General_Expenses_Analysis_Prior_Year()
        {
            InitializeComponent();
        }
