...
{
    /// <summary>
    /// Interaction logic for Equip_Employee_Assignment_Detailed.xaml
    /// </summary>
    public partial class Equip_Employee_Assignment_Detailed : Window
    {
        public Equip_Employee_Assignment_Detailed()
        {
            InitializeComponent();
        }
