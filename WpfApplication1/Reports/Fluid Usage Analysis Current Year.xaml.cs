...
{
    /// <summary>
    /// Interaction logic for Fluid_Usage_Analysis_Current_Year.xaml
    /// </summary>
    public partial class Fluid_Usage_Analysis_Current_Year : Window
    {
        public Fluid_Usage_Analysis_Current_Year()
        {
            InitializeComponent();
        }
