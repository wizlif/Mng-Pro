...
{
    /// <summary>
    /// Interaction logic for General_Expenses_Analysis_Current_Year.xaml
    /// </summary>
    public partial class General_Expenses_Analysis_Current_Year : Window
    {
        public General_Expenses_Analysis_Current_Year()
        {
            InitializeComponent();
        }
